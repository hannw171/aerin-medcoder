...
export function PolicyMappingTab() {
      ...
      <div id="tour-policies-header" className="flex-shrink-0 space-y-6 pb-6 bg-background sticky top-0 z-20">
        <div className="flex justify-between items-center pt-4">
          <div className="max-w-2xl pr-8">
            <h1 className="text-2xl font-bold text-on-background">Pemetaan Kode (ICD-10)</h1>
            <p className="text-on-surface-variant text-sm mt-1">
              Atur aturan substitusi kode ICD-10 yang akan dipatuhi oleh AI secara deterministik.
            </p>
          </div>
